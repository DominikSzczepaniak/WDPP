...
def suma2(L): #[!]
    ...
    wynik = L[0] #albo to zmienić na 0, albo range(1, len(L))
...
def histogram(L):
    ...
    #zakladajac, ze liczby w L <10:
    # for liczba in L:
    #     print(str(liczba), end = " " * 3)
    #     print("*"*liczba)
    #zakladajac, ze liczby w L <1000
    for liczba in L:
        print(str(liczba), end = " "*(3-len(str(liczba))))
        print("*"*liczba)
